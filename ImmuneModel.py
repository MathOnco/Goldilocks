...
class ImmuneModel:
    ...
    def __init__(self, UID, resistance=True):
        ...
        # self.T_0 = start_pops[0]   #Tumor cells
        # self.E_0 = start_pops[1]   #Effector cells
        # self.R_0 = start_pops[2]   #Treg cells
        # self.M_0 = start_pops[3]  #Memory cells
        # self.N_0 = start_pops[4]   #Naive cells
    ...
    def simulate(self, num_cycles):
        ...
        while curr_cycle < num_cycles:
            ...
            if self.resistance:
                ...
                new_E = total_growth[-1][1]* (1 - self.chemo_strength)
                new_R = total_growth[-1][2]* (1 - self.chemo_strength)
                new_M = total_growth[-1][3]* (1 - self.chemo_strength)
                new_N = total_growth[-1][4]* (1 - self.chemo_strength)
        ...
        total_growth = numpy.real(total_growth)
        dataframe = pandas.DataFrame(total_growth, index=total_time, columns=list('TERMN'))
        

        return dataframe


mod = ImmuneModel('test')
